          ...
          <div>
            <Input
              ...
              onChange={(event) => {
                ...
                setFormData((prev) => {
                  const existingFiles = prev[getControlItem.name] || [];

                  // Combine and filter duplicates by name + size
                  const allFiles = [...existingFiles, ...newFiles].reduce(
                    (acc, file) => {
