...
export const createNewOrder = createAsyncThunk(
  ...
  async (orderData) => {
    console.log(orderData, "orderData in createNewOrder");
    const response = await axios.post(`${url}shop/order/create`, orderData);

    console.log(response.data, "response in createNewOrder");
...
export const capturePayment = createAsyncThunk(
  ...
  async ({ paymentId, payerId, orderId }) => {
    const response = await axios.post(`${url}shop/order/capture`, {
      paymentId,
      payerId,
      orderId,
    });
